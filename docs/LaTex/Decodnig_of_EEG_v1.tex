...
\begin{thebibliography}{99}
	...
	\bibitem{physionet_eegmmidb} Schalk, G. et al.: EEG Motor Movement/Imagery Dataset. PhysioNet. Dostępne na: \url{https://physionet.org/content/eegmmidb/1.0.0/} (dostęp: 14.06.2024).
\end{thebibliography}
